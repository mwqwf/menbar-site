...
- **مزامنة حيّة**: يقرأ الكتالوج (الأقسام والأقسام الفرعية والدروس) من
  **minbar-api** (Cloudflare Workers + D1) — أي درس يُنشر في التطبيق يظهر هنا
  فوراً. وعند تعذّره تُستعمل لقطةٌ احتياطية على jsDelivr، ثم Firestore أخيراً
  (بقيّةٌ من المعمارية القديمة تُطفأ عند إغلاق المشروع).
